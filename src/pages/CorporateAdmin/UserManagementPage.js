...
import { PlusCircle, Edit, Trash2, RotateCcw, CheckCircle, XCircle } from 'lucide-react';
...
function UserManagementPage({ onLogout, isGracePeriod, currentUserId }) { 
  ...
  // normalize currentUserId to string for consistent comparisons
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Entity Access</th>
