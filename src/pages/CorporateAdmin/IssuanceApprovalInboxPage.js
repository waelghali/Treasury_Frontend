                                        ...
                                        {filteredRequests.map(req => (
                                            ...
                                            >
                                                <div className="flex items-start justify-between">
                                                    <div>
                                                        <span className="font-bold text-base text-gray-900 block">{req.serial_number || `#${req.id}`}</span>
                                                        <span className="text-xs text-gray-500">{req.requestor_name || 'Treasury'} ({req.department || 'General'})</span>
                                                    </div>
                                                    <span className="px-2.5 py-0.5 inline-flex text-xs font-bold rounded-full bg-yellow-100 text-yellow-800">
                                                ...
                                                <div className="bg-gray-50 p-2.5 rounded-lg text-xs text-gray-600 space-y-1">
                                                    <div className="flex justify-between">
                                                        <span className="text-gray-400">Beneficiary:</span>
                                                        <span className="font-medium text-gray-800">{req.beneficiary_name}</span>
                                                    </div>
                                                    {req.target_bank_name && (
                                                        <div className="flex justify-between">
                                                            <span className="text-gray-400">Target Bank:</span>
                                                            <span className="font-medium text-gray-800">{req.target_bank_name}</span>
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-2 pt-2 border-t border-gray-100">
                                                    <button
                                                        ...
                                                        className="w-full flex items-center justify-center py-2 px-3 text-xs font-bold rounded-lg text-white bg-green-600 hover:bg-green-700 disabled:opacity-50 transition-colors shadow-sm"
                                                    >
                                                        {processingId === req.id ? (
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={processingId === req.id}
                                                        className="w-full flex items-center justify-center py-2 px-3 text-xs font-bold rounded-lg text-white bg-amber-500 hover:bg-amber-600 disabled:opacity-50 transition-colors shadow-sm"
                                                    >
                                                        {processingId === req.id ? (
                                                            <Loader2 className="h-4 w-4 animate-spin" />
                                                        ) : (
                                                            <><RotateCcw className="h-4 w-4 mr-1.5" /> Revise</>
                                                        )}
                                                    </button>
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={processingId === req.id}
                                                        className="w-full flex items-center justify-center py-2 px-3 text-xs font-bold rounded-lg text-white bg-red-600 hover:bg-red-700 disabled:opacity-50 transition-colors shadow-sm"
                                                    >
                                                        {processingId === req.id ? (
                                                            <Loader2 className="h-4 w-4 animate-spin" />
                                                        ) : (
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full flex items-center justify-center py-2 px-3 text-xs font-bold rounded-lg text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors"
                                                    >
