...
export default function QuotationBankOfferPage() {
    ...
    return (
        <div className="relative min-h-screen bg-slate-100/50">
            ...
            <div className={`w-full max-w-[1400px] mx-auto p-4 sm:p-8 py-6 sm:py-8 font-sans transition-all duration-500 ${
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-slate-950 text-white rounded-2xl flex items-center justify-center shadow-lg shrink-0">
                            <Landmark size={26} />
                        </div>
                        <div>
                ...
                {activeTab === 'LIVE' && (
                    <>
                        ...
                        {resultStatus && (
                            <div
                                className={`mb-6 p-5 sm:p-6 rounded-3xl border text-center animate-fade-in-up ${
                            ...
                            >
                                {resultStatus === 'WINNER' ? (
                                    <div className="flex flex-col items-center">
                                        ...
                                        <p className="text-xs sm:text-sm">Congratulations, your quote was selected as the winning offer. Our treasury team will contact you shortly.</p>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <p className="text-xs sm:text-sm">Thank you for your quote. The corporate treasury team is currently evaluating all counterparties.</p>
                                    </div>
                                ) : resultStatus === 'INDICATIVE_ONLY' ? (
                                    <div className="flex flex-col items-center">
                                        <h2 className="text-lg sm:text-xl font-bold text-gray-800">Indicative Quotation Completed</h2>
                                        <p className="text-xs sm:text-sm text-gray-500 mt-1">Thank you for providing market sounding pricing for this request.</p>
                                    </div>
                                ) : resultStatus === 'INCONCLUSIVE' ? (
                                    <div className="flex flex-col items-center">
                                        <h2 className="text-lg sm:text-xl font-bold text-gray-800">Quotation Closed Without Winner</h2>
                                        <p className="text-xs sm:text-sm text-gray-500 mt-1">This request closed without trade execution due to tolerance limits or market conditions.</p>
                                    </div>
                                ) : (
                                    <div className="flex flex-col items-center">
                                        <h2 className="text-lg sm:text-xl font-bold">Quotation Completed</h2>
                                        <p className="text-xs sm:text-sm">Thank you for your prompt quote. Another counterparty was executed for this deal.</p>
                                    </div>
                                )}
                            </div>
                        )}
                        ...
                        <div className="mb-6 p-4 sm:p-5 bg-white rounded-2xl border border-slate-200 shadow-xs flex items-center justify-between">
                            <div>
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-xs sm:text-sm font-mono font-bold text-black bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-200">{rfq.ref_no}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                            ...
                            <div className="space-y-6">
                                <section className="bg-white p-6 sm:p-8 rounded-3xl shadow-xs border border-slate-200">
                                    <div className="flex items-center justify-between mb-6 pb-2 border-b border-slate-100">
                                        ...
                                        <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider bg-slate-100 text-slate-700 border border-slate-200">
                                        ...
                                        {rfq.type === 'TBILL' ? (
                                            ...
                                            <>
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-base font-semibold text-gray-900">{new Date(rfq.value_date).toLocaleDateString()}</p>
                                                </div>
                                                <div>
                                                    <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">Quotation Base</label>
                                                    <p className="text-base font-semibold text-gray-900">{rfq.quotation_base}</p>
                                                </div>
                                            </>
                                        )}
                                    </div>
                                ...
                                <section className="bg-white p-6 sm:p-8 rounded-3xl shadow-xs border border-slate-200">
                                    ...
                                    <ul className="space-y-4 text-xs text-gray-600 leading-relaxed">
                                        ...
                                        <li className="flex gap-3">
                                            <span className="w-5 h-5 bg-slate-100 rounded-full shrink-0 flex items-center justify-center text-[10px] font-bold text-slate-600 mt-0.5">1</span>
                                            <span>Review currency volume, value dates, and document attachments thoroughly.</span>
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="w-5 h-5 bg-slate-100 rounded-full shrink-0 flex items-center justify-center text-[10px] font-bold text-slate-600 mt-0.5">2</span>
                                            <span>You may amend your quote in real-time as market conditions change until the window closes.</span>
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="w-5 h-5 bg-slate-100 rounded-full shrink-0 flex items-center justify-center text-[10px] font-bold text-slate-600 mt-0.5">3</span>
                            ...
                            <div className="space-y-6">
                                {submitted && (
                                    <div className="bg-emerald-50 p-5 rounded-3xl border border-emerald-200 text-center animate-fade-in-up">
                                        <CheckCircle2 className="mx-auto text-emerald-500 mb-1.5" size={32} />
                                        <h2 className="text-base font-bold text-emerald-900 mb-0.5">Quote Recorded Successfully</h2>
                                ...
                                <section
                                    className={`p-6 sm:p-8 rounded-3xl shadow-xs border transition-all ${
                                        isViewOnly
