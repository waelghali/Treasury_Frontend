    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-2xl p-8 space-y-6 border border-gray-200">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              placeholder="system.owner@example.com"
              value={email}
        ...
        <div className="text-center text-sm text-gray-600 space-y-2">
          ...
          {/* New button to go back to the landing page */}
          <div className="pt-2">
            <Link to="/" className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              Back to Home
            </Link>
          </div>
        </div>
