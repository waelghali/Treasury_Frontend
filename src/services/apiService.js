...
export const API_BASE_URL_V2 = process.env.REACT_APP_API_BASE_URL; // Your FastAPI backend URL for v2 endpoints (NEW)
console.log('API base URL:', apiBaseUrl);
console.log('Full login URL:', `${apiBaseUrl}/login`);
